...
public class MoveElevatorWristLevelFour extends ParallelCommandGroup {
  /** Creates a new MoveElevatorWristLevelFour. */
  private final Elevator m_elevator;
  private final Wrist m_wrist;

  public MoveElevatorWristLevelFour(Elevator elevatorInput, Wrist wristInput) {
