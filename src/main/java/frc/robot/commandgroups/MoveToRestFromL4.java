...
public class MoveToRestFromL4 extends SequentialCommandGroup {
  /** Creates a new MoveToRest. */
  private final Elevator m_elevator;
  private final Wrist m_wrist;

  public MoveToRestFromL4(Elevator elevatorInput, Wrist wristInput) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    m_elevator = elevatorInput;
    m_wrist = wristInput;

    addCommands(new ConditionalSetWristPosition(m_wrist, 206));
    addCommands(new ConditionalSetElevatorPosition(m_elevator, 4.1));
