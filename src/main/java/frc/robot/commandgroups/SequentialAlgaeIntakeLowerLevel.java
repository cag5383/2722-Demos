...
public class SequentialAlgaeIntakeLowerLevel extends SequentialCommandGroup {
  /** Creates a new SequentialAlgaeIntakeLowerLevel. */
  private final Wrist m_wrist;
  private final Intake m_intake;
  private final Elevator m_elevator;

  public SequentialAlgaeIntakeLowerLevel(Wrist wristInput, Intake intakeInput, Elevator elevatorInput) {
    ...
    addCommands(new ConditionalSetElevatorPosition(m_elevator, ElevatorConstants.kElevatorL3Setpoint));
    addCommands(new ConditionalSetWristPosition(m_wrist, WristConstants.kWristAlgaeIntakeSetpoint));
    addCommands(new ConditionalSetElevatorPosition(m_elevator, ElevatorConstants.kElevatorLowerAlgaeRemove));
